			...
			<section className='Experiencia flex'>
				...
				<div className='border flex'>
					<div className='mar'>
						...
						<img className='iconGrow' src={imagepy} alt='Python icon' title='Python 3' width='40' height='40'/>
					</div>
				...
				<div className='border flex'>
					<div className='mar'>
						...
						<img className='iconGrow' src={imagejava} alt='Java icon' title='Java 8' width='40' height='40'/>
						<img className='iconGrow' src={imagesql} alt='SQL icon' title='MySQL' width='40' height='40'/>
					</div>
				...
				<div className="border flex">
					<div className='mar'>
						...
						<img className='iconGrow' src={imagereact} alt='React icon' title='React' width='40' height='40'/>
						<img className='iconGrow' src={imagecss} alt='CSS icon' title='CSS 3' width='40' height='40'/>
					</div>
